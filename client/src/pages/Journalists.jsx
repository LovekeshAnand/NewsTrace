    ...
    <div className="space-y-6">
      <div className="flex gap-4">
        <input
          ...
          className="flex-1 px-4 py-3 bg-slate-800 border border-slate-700 rounded-lg text-white placeholder-slate-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
        />
        <button
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {journalists.map((journalist) => (
            <div 
              key={journalist.id} 
              className="bg-slate-800 rounded-xl border border-slate-700 p-6 hover:border-purple-500 transition-all"
            >
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-white truncate">{journalist.name}</h3>
              ...
              <div className="flex items-center justify-between text-sm mb-3">
                ...
                <span className="font-semibold text-white">{journalist.articleCount}</span>
              </div>
